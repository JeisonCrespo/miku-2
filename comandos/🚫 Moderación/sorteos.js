      ...
      case "start":
        {
          let embed = new Discord.EmbedBuilder()
            .setDescription(
              `**Uso:** \`${prefix}sorteo <#canal> <duración> <ganadores> <premio>\``
            )
            .setColor("FF0000");
          ...
          if (!canal)
            return message.reply({
              embeds: [
                embed.setTitle(`❌ Tienes que especificar un canal válido!`),
              ],
            });
          let tiempo = args[2];
          if (!tiempo)
            return message.reply({
              embeds: [
                embed.setTitle(
                  `❌ Tienes que especificar una duración del sorteo válida!`
                ),
              ],
            });
          ...
          if (
            ...
            return message.reply({
              embeds: [
                embed.setTitle(
                  `❌ Tienes que especificar una cantidad de ganadores válida!`
                ),
              ],
            });
          ...
          if (!premio)
            return message.reply({
              embeds: [
                embed.setTitle(`❌ Tienes que especificar un premio válido!`),
              ],
            });
          ...
          client.giveawaysManager
            .start(canal, {
              ...
              messages: {
                ...
                winMessage:
                  "🎉 Enhorabuena {winners} has/habéis ganado **{this.prize}**",
                winners: "Ganador(es)",
